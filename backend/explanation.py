...
def generate_explanation(text, concept):
    prompt = f"Explain the concept {concept} with an in-depth intermediate explanation."
...
if __name__ == "__main__":
    ...
    print(generate_explanation(concatenated_text, concept))
