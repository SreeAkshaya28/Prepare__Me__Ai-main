...
def generate_flowchart(text, concept):
    prompt = f"Describe a flowchart for the process involved in {concept}."
...
if __name__ == "__main__":
    ...
    print(generate_flowchart(concatenated_text, concept))
